...
CustomKeywords.'com.CheckElementPresentTest.checkElementPresentTest'(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username'), 
    10)
...
//CustomKeywords.'com.LoginKeywords.LoginTestK'()
...
WebUI.click(findTestObject('Page_CURA Healthcare Service/h2_Appointment'))
